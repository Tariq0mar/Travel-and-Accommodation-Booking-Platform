        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdultsCount = table.Column<byte>(type: "tinyint", nullable: false),
                    ChildrenCount = table.Column<byte>(type: "tinyint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomCategoryDiscounts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoomCategoryDiscounts_Discounts_DiscountId",
                        column: x => x.DiscountId,
                        principalTable: "Discounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoomCategoryDiscounts_RoomCategories_RoomCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HotelGalleries_Galleries_GalleryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoomGalleries_Galleries_GalleryId",
                        column: x => x.GalleryId,
                        principalTable: "Galleries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelGalleries_GalleryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomCategoryDiscounts_DiscountId",
                table: "RoomCategoryDiscounts",
                column: "DiscountId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomCategoryDiscounts_RoomCategoryId",
                table: "RoomCategoryDiscounts",
                column: "RoomCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomGalleries_GalleryId",
                table: "RoomGalleries",
                column: "GalleryId");
